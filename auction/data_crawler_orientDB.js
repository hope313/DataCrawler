...
var y_day = day - 1;
var t_day = day + 7;
if(y_day < 10) y_day = '0' + y_day;
if(t_day < 10) t_day = '0' + t_day;

var today = year + '.' + month + '.' + day;
var start_day = year + '.' + month + '.' + y_day;
var end_day = year + '.' + month + '.' + t_day;

//console.log(today + '___' + start_day + '___' + end_day);
...
for(var s=0; s<sidoGugunList.length; s++) {
  ...
  for(var g=0; g<sidoGugunList[s][2].length; g++) {
    ...
    var p = client.fetch(targetURL, {
      ...
      dong : '',
      s_date_from : start_day,    // '2018.02.26',
      s_date_to : end_day,       //'2018.05.26',
      MAIN_CATE : 'web',
